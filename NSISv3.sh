...
echo "    #         #######     ############ $red " | lolcat
echo ""
echo "1!1!1!1!1!1!1!1..Kontoeeeeeeeell......$green " | lolcat
echo ""
echo "#     #     #     #####         ######### $red " | lolcat
echo "#     # #   #     #    #       #         # $red " | lolcat
echo "#     #  #  #     #     #      #         # $red " | lolcat
...
echo "=================="
echo "15.Hack WA $yellow " | lolcat
echo "=================="
echo "16.Install LazyGo $green " | lolcat
echo "=================="
echo "17.Bukan-Untuk-Umum $yellow " | lolcat
echo "=================="
echo "18.Install FakeCall $red " | lolcat
echo "=================="
echo "19.Install IslamPray $orange " | lolcat
echo "=================="
echo "20.Install ARTEMATIKA $yellow " | lolcat
echo "========================================================="
read -p "r00t@NimrakMill~# " pill
if [ $pill = 1 ]
then
clear
echo "Tungguu Kontoeell....1!1!1"
echo
sleep 1
pkg install git
git clone https://github.com/DarknessCyberTeam/...
cd BAJINGANv6
sh BAJINGAN.sh
fi
...
apt install bash
apt install git
git clone https://github.com/21D4N404/tools-installer.git
cd tools-installer
sh install.sh
fi
...
sleep 1
pkg install git
git clone https://github.com/kadal15/bukan-untuk-umum
cd bukan-untuk-umum
sh M7M-installer.sh
fi
